...
export const skillGroups: SkillGroup[] = [
  {
    ...
    skills: [
      ...
      { id: 'typescript', label: 'TypeScript', level: 4, provenBy: ['this-site'] },
  ...
  },
  {
    ...
    skills: [
      ...
      { id: 'concurrent-programming', label: 'Concurrent programming', level: 5, provenBy: ['parallel-data-framework'] },
      { id: 'posix-threads', label: 'POSIX threads', level: 5, provenBy: ['parallel-data-framework'] },
